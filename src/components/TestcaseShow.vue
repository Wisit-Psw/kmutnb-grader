...
const state = reactive({isEditing: true})
...
<template>
    <div class="Container">
        <div class="icon-wrap">
            ...
            <div class="testcaselist" v-for="(Case,index) in data.Testcase" :key="index" v-if="state.isEditing">
                ...
                <div class="casetext">
                    ...
                    <input type="checkbox" :checked="Case.stdin" @change="(e) => console.log(e.target.checked)"/>
                </div>
            </div>
        </div>
    </div>
