...
defineEmits(["onAddAssingBtnClick"])
...
const ReadFile = (file: any) => {
    ...
    fileReader.onload = () => {
        Probs.Testcase.push(typeof fileReader.result === "string" ? fileReader.result : "");
        console.log(Probs.Testcase)
    }
...
<template>
    <div class="Container">
        <div class="icon-wrap">
            ...
            <div class="controller" @submit="onCreateBtnClick">
                <form class="formWrap" @submit="">
                    ...
                    <div :class="`inputWrapper ${state.Linkfocus || (Probs.Link !== '') ? 'focus' : ''}`">
                        ...
                        <input type="file" class="inputbox" id="inputbox_file" accept=".sol" @change="onFileChange" />
                    </div>
